// requette pour actualiser le jeu
...
etat = false;
  ...
  for (var idx_fin = 0; idx_fin < partie.joueur.length; idx_fin++) {
    if (partie.joueur[idx_fin].pv >= 17) {
      etat = true;
    }
  }

  if (partie.tour == i && etat === false) {

      partie.joueur[i].action = 3;
  ...
  marqueurs.resultat1 = "Defaite";
  marqueurs.resultat2 = "Un adversaire a recolté plus de 17 points de victoire";
